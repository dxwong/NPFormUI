...
namespace DataGridWithFilter
{
    public class DataGridFilterHeader : DataGridViewColumnHeaderCell
    {
                                      ...
                                      DataGridViewPaintParts paintParts)
        {
            ...
            _buttonRect = new Rectangle(cellBounds.X + cellBounds.Width - Width, cellBounds.Y-3, Width, cellBounds.Height-3);
            _cellLocation = cellBounds.Location;
            ComboBoxRenderer.DrawDropDownButton(graphics, _buttonRect, _currentState);
            //var brush = new TextureBrush(new Bitmap(@"d:\filter_9px.png"));//实例化纹理画刷
            //graphics.FillRectangles(brush, new Rectangle[] { _buttonRect });
            //System.Windows.Forms.ButtonRenderer.DrawButton(graphics, _buttonRect, _currentState);
        }
